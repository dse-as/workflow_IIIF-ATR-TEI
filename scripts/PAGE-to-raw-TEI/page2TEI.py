...
This code is largely based on https://github.com/raykyn/page2tei
MIT License (c) 2022 Ismail M. Prada Ziegler for the University of Berne
"""
...
# load external files
tag_name_conversion = json.load(open("scripts/PAGE-to-raw-TEI/tag_name_conversion.json", encoding="utf8"))
tag_deepness = json.load(open("scripts/PAGE-to-raw-TEI/tag_deepness.json", encoding="utf8"))
